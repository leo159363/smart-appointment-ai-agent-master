...
class AppointmentService:
    ...
    def save_appointment(self, technician_id: str, start_time: datetime, 
        ...
        try:
            ...
            logger.info(f"预约信息已保存到数据库：老师ID={technician_id}, 时间={start_time} 到 {end_time}, 预约ID={appointment_id}")
            return True
